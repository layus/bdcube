...
State x = \\($x_1,x_2$) ($x_1,x_2\in \{0,1\}$)\\[0.3cm]	
	\begin{tikzpicture}
	\node[decision](d1) {};
...
\end{itemize}%\\[2cm]
\vspace{2cm}
Then: $Succ_S(x')=\exists(\phi_S(x) \wedge Trans(x,x'))$
\end{frame}
...
\section{Conclusion}
\begin{frame}
\frametitle{Conclusion: avantage des BDD pour la recherche symbolique}
\begin{itemize}
